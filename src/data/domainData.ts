...
export const domainNavItems: Record<BusinessDomain, Record<string, string[]>> = {
  'Общий': { 'Основные': ['Чат', 'Сообщения', 'Задачи'], 'Команда': ['Вся команда', 'Менеджер'], 'Библиотека': ['Документы', 'Дневник'] },
  ...
  'Управление': { 'Команда': ['Команда', 'Менеджер', 'Обсуждения'], 'HR': ['Страницы', 'Геймификация'] },
